...
public class PruebasController {
    ...
    public String consultaPorExistencias(
            @RequestParam("existenciasMin") int existenciasMin,
            @RequestParam("existenciasMax") int existenciasMax,
            Model model) {
        List<Producto> productos = productoService.obtenerProductosPorExistenciasRango(existenciasMin, existenciasMax);
        model.addAttribute("productos", productos);
        return "pruebas/listado2";
    }
}
